...
export const metadata: Metadata = {
  title: "Genesis",
  metadataBase: new URL("https://genesis.digitalax.xyz/"),
  description: "Lens Mainnet Mint.",
  twitter: {
    description: "Lens Mainnet Mint.",
    creator: "@digitalax_",
    site: "@digitalax_",
  ...
  alternates: {
    canonical: `https://genesis.digitalax.xyz/`,
    languages: LOCALES.reduce((acc, item) => {
      acc[item] = `https://genesis.digitalax.xyz/${item}/`;
      return acc;
